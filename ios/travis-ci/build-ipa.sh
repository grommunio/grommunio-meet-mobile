...
xcodebuild archive -quiet -workspace ios/jitsi-meet.xcworkspace -scheme grommunio-meet -configuration Release -archivePath /tmp/grommunio-meet/jitsi-meet.xcarchive
