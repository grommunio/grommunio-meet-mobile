grommunio meet - redux state persistence
====================================
grommunio meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, grommunio meet will automatically persist these subtrees and
